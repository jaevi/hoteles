...
use Jaevi\HotelesBundle\Entity\Habitacion;
use Jaevi\HotelesBundle\Form\HabitacionType;
...
class HabitacionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('JaeviHotelesBundle:Habitacion')->findAll();
     ...
     * @Method("POST")
     * @Template("JaeviHotelesBundle:Habitacion:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('JaeviHotelesBundle:Habitacion')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("JaeviHotelesBundle:Habitacion:edit.html.twig")
     */
