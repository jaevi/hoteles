...
use Jaevi\HotelesBundle\Entity\Hotel;
use Jaevi\HotelesBundle\Form\HotelType;
...
class HotelController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('JaeviHotelesBundle:Hotel')->findAll();
     ...
     * @Method("POST")
     * @Template("JaeviHotelesBundle:Hotel:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('JaeviHotelesBundle:Hotel')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("JaeviHotelesBundle:Hotel:edit.html.twig")
     */
