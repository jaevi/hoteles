...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '41dcbbd306b31e1c83db25b0ed37ee14462c0a6a6bdd94ba197648a650e0404d_1' => 'get41dcbbd306b31e1c83db25b0ed37ee14462c0a6a6bdd94ba197648a650e0404d1Service',
            '41dcbbd306b31e1c83db25b0ed37ee14462c0a6a6bdd94ba197648a650e0404d_2' => 'get41dcbbd306b31e1c83db25b0ed37ee14462c0a6a6bdd94ba197648a650e0404d2Service',
            '41dcbbd306b31e1c83db25b0ed37ee14462c0a6a6bdd94ba197648a650e0404d_3' => 'get41dcbbd306b31e1c83db25b0ed37ee14462c0a6a6bdd94ba197648a650e0404d3Service',
            '8096028fdcc3890b4c8cfc1b228fd8098f429775519e3dd6f0cf0ed74afa7fa0_1' => 'get8096028fdcc3890b4c8cfc1b228fd8098f429775519e3dd6f0cf0ed74afa7fa01Service',
    ...
    /**
     * Gets the '41dcbbd306b31e1c83db25b0ed37ee14462c0a6a6bdd94ba197648a650e0404d_1' service.
     *
     ...
     */
    protected function get41dcbbd306b31e1c83db25b0ed37ee14462c0a6a6bdd94ba197648a650e0404d1Service()
    {
        return $this->services['41dcbbd306b31e1c83db25b0ed37ee14462c0a6a6bdd94ba197648a650e0404d_1'] = new \Swift_Transport_Esmtp_Auth_CramMd5Authenticator();
    }

    /**
     * Gets the '41dcbbd306b31e1c83db25b0ed37ee14462c0a6a6bdd94ba197648a650e0404d_2' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function get41dcbbd306b31e1c83db25b0ed37ee14462c0a6a6bdd94ba197648a650e0404d2Service()
    {
        return $this->services['41dcbbd306b31e1c83db25b0ed37ee14462c0a6a6bdd94ba197648a650e0404d_2'] = new \Swift_Transport_Esmtp_Auth_LoginAuthenticator();
    }

    /**
     * Gets the '41dcbbd306b31e1c83db25b0ed37ee14462c0a6a6bdd94ba197648a650e0404d_3' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function get41dcbbd306b31e1c83db25b0ed37ee14462c0a6a6bdd94ba197648a650e0404d3Service()
    {
        return $this->services['41dcbbd306b31e1c83db25b0ed37ee14462c0a6a6bdd94ba197648a650e0404d_3'] = new \Swift_Transport_Esmtp_Auth_PlainAuthenticator();
    }

    /**
     * Gets the '8096028fdcc3890b4c8cfc1b228fd8098f429775519e3dd6f0cf0ed74afa7fa0_1' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function get8096028fdcc3890b4c8cfc1b228fd8098f429775519e3dd6f0cf0ed74afa7fa01Service()
    {
        return $this->services['8096028fdcc3890b4c8cfc1b228fd8098f429775519e3dd6f0cf0ed74afa7fa0_1'] = new \Symfony\Component\Form\ResolvedFormTypeFactory();
    }
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/home/jaevi/hoteles/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/home/jaevi/hoteles/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', '/home/jaevi/hoteles/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/home/jaevi/hoteles/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'hoteles', 'user' => 'hoteles', 'password' => 112233, 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_1be2417656aaa590c32dcd8d2ed2837ec9ed5abfb1d9b918caadb82a78c5d0da');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_1be2417656aaa590c32dcd8d2ed2837ec9ed5abfb1d9b918caadb82a78c5d0da');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_1be2417656aaa590c32dcd8d2ed2837ec9ed5abfb1d9b918caadb82a78c5d0da');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => '/home/jaevi/hoteles/src/Jaevi/HotelesBundle/Entity')), 'Jaevi\\HotelesBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('JaeviHotelesBundle' => 'Jaevi\\HotelesBundle\\Entity'));
        $e->setMetadataCacheImpl($a);
        $e->setQueryCacheImpl($b);
        $e->setResultCacheImpl($c);
        $e->setMetadataDriverImpl($d);
        $e->setProxyDir('/home/jaevi/hoteles/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/home/jaevi/hoteles/app/Resources');
    }
    ...
    {
        return $this->services['form.resolved_type_factory'] = new \Symfony\Component\Form\Extension\DataCollector\Proxy\ResolvedTypeFactoryDataCollectorProxy($this->get('8096028fdcc3890b4c8cfc1b228fd8098f429775519e3dd6f0cf0ed74afa7fa0_1'), $this->get('data_collector.form'));
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/home/jaevi/hoteles/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/home/jaevi/hoteles/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/home/jaevi/hoteles/app/cache/dev/assetic/routing.yml', array('cache_dir' => '/home/jaevi/hoteles/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/home/jaevi/hoteles/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/home/jaevi/hoteles/app');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/home/jaevi/hoteles/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        $a = new \Swift_Transport_Esmtp_AuthHandler(array(0 => $this->get('41dcbbd306b31e1c83db25b0ed37ee14462c0a6a6bdd94ba197648a650e0404d_1'), 1 => $this->get('41dcbbd306b31e1c83db25b0ed37ee14462c0a6a6bdd94ba197648a650e0404d_2'), 2 => $this->get('41dcbbd306b31e1c83db25b0ed37ee14462c0a6a6bdd94ba197648a650e0404d_3')));
        $a->setUsername(NULL);
        $a->setPassword(NULL);
        $a->setAuthMode(NULL);
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/home/jaevi/hoteles/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => '/home/jaevi/hoteles/app/cache/dev/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/home/jaevi/hoteles/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/home/jaevi/hoteles/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/home/jaevi/hoteles/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/home/jaevi/hoteles/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', 'Security');
        $instance->addPath('/home/jaevi/hoteles/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath('/home/jaevi/hoteles/vendor/symfony/swiftmailer-bundle/Symfony/Bundle/SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('/home/jaevi/hoteles/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('/home/jaevi/hoteles/src/Jaevi/HotelesBundle/Resources/views', 'JaeviHoteles');
        $instance->addPath('/home/jaevi/hoteles/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('/home/jaevi/hoteles/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('/home/jaevi/hoteles/app/Resources/views');
        $instance->addPath('/home/jaevi/hoteles/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => '/home/jaevi/hoteles/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml'));
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/home/jaevi/hoteles/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/home/jaevi/hoteles/app/cache/dev/assetic/assets');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('53f619b1c5395')), true);
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/home/jaevi/hoteles/app/cache/dev');
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/home/jaevi/hoteles/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/home/jaevi/hoteles/app/cache/dev',
            'kernel.logs_dir' => '/home/jaevi/hoteles/app/logs',
            'kernel.bundles' => array(
                ...
                'JaeviHotelesBundle' => 'Jaevi\\HotelesBundle\\JaeviHotelesBundle',
            ...
            'debug.container.dump' => '/home/jaevi/hoteles/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => '/home/jaevi/hoteles/app/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:/home/jaevi/hoteles/app/cache/dev/profiler',
            ...
            'router.resource' => '/home/jaevi/hoteles/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/home/jaevi/hoteles/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => '/home/jaevi/hoteles/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/home/jaevi/hoteles/app/cache/dev/assetic',
            ...
            'assetic.read_from' => '/home/jaevi/hoteles/app/../web',
            'assetic.write_to' => '/home/jaevi/hoteles/app/../web',
            ...
            'doctrine.orm.proxy_dir' => '/home/jaevi/hoteles/app/cache/dev/doctrine/orm/Proxies',
